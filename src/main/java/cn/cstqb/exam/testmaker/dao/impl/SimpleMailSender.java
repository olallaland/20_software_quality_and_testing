...
//    public void send(List recipients, String subject, Object content) throws AddressException, MessagingException {
//
//        //创建Mime类型邮件
//        final MimeMessage message = new MimeMessage(session);
//
...
//
//        for (int i = 0; i recipients, SimpleMail mail) throws AddressException, MessagingException
//        {
